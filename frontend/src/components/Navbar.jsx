...
function Navbar({ className }) {
  ...
  return (
    <nav className={`login-navbar mt-0 rounded-xl md:mt-4 [.light_&]:!bg-white h-16 w-full md:w-3xl md:mx-auto md:left-0 md:right-0 !absolute px-4 font-rmneue flex items-center justify-between z-10 ${className}`}>
      {/* {<BurgerMenu />} */}
